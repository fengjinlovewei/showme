import { version, defineComponent, h, inject, computed, unref, ref, provide, shallowReactive, watch, Suspense, nextTick, Transition, useSSRContext, hasInjectionContext, mergeProps, withCtx, createVNode, createApp, effectScope, reactive, getCurrentInstance, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
...
import { f as useRuntimeConfig$1, i as createError$1, m as createHooks, n as sanitizeStatusCode } from '../nitro/node-server.mjs';
...
const mr = Symbol.toStringTag, bi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Ns = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Hs = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./_nuxt/multipart-parser-BWTKQqcY.mjs');
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/index-CPs_Iycu.mjs').then((m) => m.default || m)
  }
];
  ...
  routes: (_routes2) => {
    return [
      ...
      },
      {
        name: "main",
        path: "/",
        component: () => import('./_nuxt/index-CPs_Iycu.mjs')
      }
    ];
  }
};
...
const layouts = {
  default: () => import('./_nuxt/default-Ddq7fPWR.mjs').then((m) => m.default || m)
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "error-page" }, _attrs))} data-v-1d2d4be9><header data-v-1d2d4be9><a href="/" alt="main" data-v-1d2d4be9>回首页</a></header><div class="main" data-v-1d2d4be9><h1 class="title" data-v-1d2d4be9>An error occurred!</h1><p class="tip" data-v-1d2d4be9>We cannot complete your request possibly due to unstable network or a missing page.</p><a href="/" alt="main" data-v-1d2d4be9><div class="error-btn" data-v-1d2d4be9>Back to homepage</div></a></div></div>`);
}
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1d2d4be9"]]);
const error = /* @__PURE__ */ Object.freeze({
  __proto__: null,
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-2jqVpMXF.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { Bn as B, _export_sfc as _, asyncDataDefaults as a, br as b, createError as c, entry$1 as default, fetchDefaults as f, useNuxtApp as u };
